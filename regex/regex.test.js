...
/* You have a text that contain image names with their extentions you need to write a function to 
find all images in that text and return their names and extentions in an array 

required extentions are jpg, jpeg and png.

*/

function imagesSeracher(text){
    let arr = [];
    // Add your logic.
    return arr
}
